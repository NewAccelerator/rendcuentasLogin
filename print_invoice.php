...
$output .= '<table width="100%" border="1" cellpadding="5" cellspacing="0">
	<tr>
	<td colspan="2" align="center" style="font-size:18px"><b>Datos Rendir Cuenta</b></td>
	</tr>
	<tr>
	<td colspan="2">
	...
	<tr>
	<td width="65%">
	Datos de Cabezera,<br />
	<b>RECEPTOR (CUENTA)</b><br />
	Mov Cuenta : '.$invoiceValues['order_receiver_name'].'<br /> 
	Motivo : '.$invoiceValues['order_receiver_address'].'<br />
	Observacion : '.$invoiceValues['note'].'<br /> 
	</td>
	<td width="35%">         
	Cuenta No. : '.$invoiceValues['order_id'].'<br />
