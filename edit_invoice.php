...
?>
<title>Sistema Rendir Cuentas</title>
	    	...
	    	<div class="load-animate animated fadeInUp">
		    	<div class="row">
		    		<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
		    			<h1 class="title">Sistema de actulizacion Cuentas</h1>
		    	...
		    	<div class="row">
		      		...
		      		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 pull-right">
		      			<h3>Insertar Datos de Cabezera,</h3>
		      			<div class="form-group">
							<input value="<?php echo $invoiceValues['order_receiver_name']; ?>" type="text" class="form-control" name="companyName" id="companyName" placeholder="Movimiento Cuenta" autocomplete="off">
						</div>
						<div class="form-group">
							<textarea class="form-control" rows="3" name="address" id="address" placeholder="Motivo"><?php echo $invoiceValues['order_receiver_address']; ?></textarea>
						</div>
...
<th width="15%">Detalle. No</th>
<th width="38%">Razon Social</th>
...
<?php } ?>		
		      	...
		      	<div class="row">	
		      		<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
		      			<h3>Observaciones: </h3>
		      			<div class="form-group">
							<textarea class="form-control txt" rows="5" name="notes" id="notes" placeholder="Tus Observaciones"><?php echo $invoiceValues['note']; ?></textarea>
						</div>
						<br>
						<div class="form-group">
							<input type="hidden" value="<?php echo $_SESSION['userid']; ?>" class="form-control" name="userId">
							<input type="hidden" value="<?php echo $invoiceValues['order_id']; ?>" class="form-control" name="invoiceId" id="invoiceId">
			      			<input data-loading-text="Updating Invoice..." type="submit" name="invoice_btn" value="Guardar Cuenta" class="btn btn-success submit_btn invoice-save-btm">
			      		</div>
		      		...
		      		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
						<span class="form-inline">
							...
							<div class="form-group">
								...
								<div class="input-group">
									<input value="<?php echo $invoiceValues['order_tax_per']; ?>" type="number" class="form-control" name="TaxRate" id="taxRate" placeholder="Tasa Impuesto">
							...
							<div class="form-group">
								<label>Cantidad Importe Viatico: &nbsp;</label>
								<div class="input-group">
									<div class="input-group-addon currency">$</div>
									<input value="<?php echo $invoiceValues['order_amount_paid']; ?>" type="number" class="form-control" name="amountPaid" id="amountPaid" placeholder="Cantidad Importe">
								</div>
							</div>
							<div class="form-group">
								<label>Cantidad Saldo: &nbsp;</label>
								<div class="input-group">
									<div class="input-group-addon currency">$</div>
									<input value="<?php echo $invoiceValues['order_total_amount_due']; ?>" type="number" class="form-control" name="amountDue" id="amountDue" placeholder="Cantidad Salddo">
								</div>
							</div>
						</span>
					</div>
